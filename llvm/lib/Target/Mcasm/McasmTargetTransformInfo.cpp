//===-- McasmTargetTransformInfo.cpp - Mcasm specific TTI pass ----------------===//
//
...
/// Mcasm target machine. It uses the target's detailed information to provide
/// more precise answers to certain TTI queries, while letting the target
/// independent and default TTI implementations handle the rest.
///
//===----------------------------------------------------------------------===//
/// About Cost Model numbers used below it's necessary to say the following:
/// the numbers correspond to some "generic" Mcasm CPU instead of usage of a
...
#include "McasmTargetTransformInfo.h"
...
McasmTTIImpl::getPopcntSupport(unsigned TyWidth) const {
...
std::optional<unsigned> McasmTTIImpl::getCacheSize(
...
std::optional<unsigned> McasmTTIImpl::getCacheAssociativity(
  TargetTransformInfo::CacheLevel Level) const {
  //   - Penryn
  //   - Nehalem
  //   - Westmere
...
unsigned McasmTTIImpl::getRegisterClassForType(bool Vector, Type *Ty) const {
  return Vector                          ? VectorClass
         : Ty && Ty->isFloatingPointTy() ? ScalarFPClass
                                         : GPRClass;
}

unsigned McasmTTIImpl::getNumberOfRegisters(unsigned ClassID) const {
...
bool McasmTTIImpl::hasConditionalLoadStoreForType(Type *Ty, bool IsStore) const {
  if (!ST->hasCF())
    return false;
  if (!Ty)
    return true;
...
TypeSize
McasmTTIImpl::getRegisterBitWidth(TargetTransformInfo::RegisterKind K) const {
...
unsigned McasmTTIImpl::getLoadStoreVecRegBitWidth(unsigned) const {
  return getRegisterBitWidth(TargetTransformInfo::RGK_FixedWidthVector)
      .getFixedValue();
}

unsigned McasmTTIImpl::getMaxInterleaveFactor(ElementCount VF) const {
...
InstructionCost McasmTTIImpl::getArithmeticInstrCost(
  ...
  // On Mcasm, vector signed division by constants power-of-two are
  ...
  static const CostKindTblEntry AVX512CostTable[] = {
    ...
    { McasmISD::PMULUDQ, MVT::v8i64, { 1,  5, 1, 1 } },
  ...
  static const CostKindTblEntry AVX2CostTable[] = {
    ...
    { McasmISD::PMULUDQ, MVT::v4i64, { 1,  5, 1, 1 } },
  ...
  static const CostKindTblEntry AVX1CostTable[] = {
    ...
    { McasmISD::PMULUDQ, MVT::v4i64, { 3,  5, 5, 6 } }, // pmuludq + split
  ...
  static const CostKindTblEntry SSE2CostTable[] = {
    ...
    { McasmISD::PMULUDQ, MVT::v2i64, { 1,  5, 1, 1 } },
  ...
  if (const auto *Entry = CostTableLookup(McasmCostTbl, ISD, LT.second))
    if (auto KindCost = Entry->Cost[CostKind])
      return LT.first * *KindCost;
...
InstructionCost
McasmTTIImpl::getAltInstrCost(VectorType *VecTy, unsigned Opcode0,
...
InstructionCost McasmTTIImpl::getShuffleCost(TTI::ShuffleKind Kind,
...
InstructionCost McasmTTIImpl::getCastInstrCost(unsigned Opcode, Type *Dst,
                                             Type *Src,
...
InstructionCost McasmTTIImpl::getCmpSelInstrCost(
...
unsigned McasmTTIImpl::getAtomicMemIntrinsicMaxElementSize() const { return 16; }

InstructionCost
McasmTTIImpl::getIntrinsicInstrCost(const IntrinsicCostAttributes &ICA,
                                  TTI::TargetCostKind CostKind) const {
  // Costs should match the codegen from:
  // BITREVERSE: llvm\test\CodeGen\Mcasm\vector-bitreverse.ll
  // BSWAP: llvm\test\CodeGen\Mcasm\bswap-vector.ll
  // CTLZ: llvm\test\CodeGen\Mcasm\vector-lzcnt-*.ll
  // CTPOP: llvm\test\CodeGen\Mcasm\vector-popcnt-*.ll
  // CTTZ: llvm\test\CodeGen\Mcasm\vector-tzcnt-*.ll
  ...
  static const CostKindTblEntry AVX512VBMI2CostTbl[] = {
    ...
    { McasmISD::VROTLI,  MVT::v32i16,  {  1,  1,  1,  1 } },
    { McasmISD::VROTLI,  MVT::v16i16,  {  1,  1,  1,  1 } },
    { McasmISD::VROTLI,  MVT::v8i16,   {  1,  1,  1,  1 } },
  };
  ...
  static const CostKindTblEntry AVX512BWCostTbl[] = {
    ...
    { McasmISD::VROTLI,  MVT::v32i16,  {  2,  5,  3,  3 } },
    { McasmISD::VROTLI,  MVT::v16i16,  {  1,  5,  3,  3 } },
    { McasmISD::VROTLI,  MVT::v8i16,   {  1,  5,  3,  3 } },
    { McasmISD::VROTLI,  MVT::v64i8,   {  2,  9,  3,  4 } },
    { McasmISD::VROTLI,  MVT::v32i8,   {  1,  9,  3,  4 } },
    { McasmISD::VROTLI,  MVT::v16i8,   {  1,  8,  3,  4 } },
  ...
  static const CostKindTblEntry AVX512CostTbl[] = {
    ...
    { McasmISD::VROTLI,  MVT::v8i64,   {  1,  1,  1,  1 } },
    { McasmISD::VROTLI,  MVT::v4i64,   {  1,  1,  1,  1 } },
    { McasmISD::VROTLI,  MVT::v2i64,   {  1,  1,  1,  1 } },
    { McasmISD::VROTLI,  MVT::v16i32,  {  1,  1,  1,  1 } },
    { McasmISD::VROTLI,  MVT::v8i32,   {  1,  1,  1,  1 } },
    { McasmISD::VROTLI,  MVT::v4i32,   {  1,  1,  1,  1 } },
  ...
  static const CostKindTblEntry XOPCostTbl[] = {
    ...
    { McasmISD::VROTLI,  MVT::v4i64,   {  4,  7,  5,  6 } },
    { McasmISD::VROTLI,  MVT::v8i32,   {  4,  7,  5,  6 } },
    { McasmISD::VROTLI,  MVT::v16i16,  {  4,  7,  5,  6 } },
    { McasmISD::VROTLI,  MVT::v32i8,   {  4,  7,  5,  6 } },
    { McasmISD::VROTLI,  MVT::v2i64,   {  1,  3,  1,  1 } },
    { McasmISD::VROTLI,  MVT::v4i32,   {  1,  3,  1,  1 } },
    { McasmISD::VROTLI,  MVT::v8i16,   {  1,  3,  1,  1 } },
    { McasmISD::VROTLI,  MVT::v16i8,   {  1,  3,  1,  1 } },
  };
  static const CostKindTblEntry AVX2CostTbl[] = {
  ...
  static const CostKindTblEntry GFNICostTbl[] = {
    ...
    { McasmISD::VROTLI,  MVT::v16i8,   {  1,  6,  1,  2 } }, // gf2p8affineqb
    { McasmISD::VROTLI,  MVT::v32i8,   {  1,  6,  1,  2 } }, // gf2p8affineqb
    { McasmISD::VROTLI,  MVT::v64i8,   {  1,  6,  1,  2 } }, // gf2p8affineqb
  };
  ...
  static const CostKindTblEntry X64CostTbl[] = { // 64-bit targets
    ...
    { McasmISD::VROTLI,  MVT::i64,     {  1,  1,  1,  1 } },
  ...
  static const CostKindTblEntry McasmCostTbl[] = { // 32 or 64-bit targets
    ...
    { McasmISD::VROTLI,  MVT::i32,     {  1,  1,  1,  1 } },
    { McasmISD::VROTLI,  MVT::i16,     {  1,  1,  1,  1 } },
    { McasmISD::VROTLI,  MVT::i8,      {  1,  1,  1,  1 } },
  ...
  case Intrinsic::llrint: {
    // Mcasm can use the CVTP2SI instructions to lower lrint/llrint calls, which
  ...
  if (ISD != ISD::DELETED_NODE) {
    ...
    if (const auto *Entry = CostTableLookup(McasmCostTbl, ISD, MTy))
      if (auto KindCost = Entry->Cost[CostKind])
        return adjustTableCost(Entry->ISD, *KindCost, LT, ICA.getFlags());
...
InstructionCost McasmTTIImpl::getVectorInstrCost(unsigned Opcode, Type *Val,
                                               TTI::TargetCostKind CostKind,
...
InstructionCost McasmTTIImpl::getScalarizationOverhead(
  ...
  if (Insert && !ForPoisonSrc) {
    ...
    // Constant::getNullValue()), which makes the McasmTTIImpl
...
InstructionCost
McasmTTIImpl::getReplicationShuffleCost(Type *EltTy, int ReplicationFactor,
...
InstructionCost McasmTTIImpl::getMemoryOpCost(unsigned Opcode, Type *Src,
                                            Align Alignment,
...
InstructionCost
McasmTTIImpl::getMemIntrinsicInstrCost(const MemIntrinsicCostAttributes &MICA,
                                     TTI::TargetCostKind CostKind) const {
  switch (MICA.getID()) {
...
InstructionCost
McasmTTIImpl::getMaskedMemoryOpCost(const MemIntrinsicCostAttributes &MICA,
                                  TTI::TargetCostKind CostKind) const {
...
InstructionCost McasmTTIImpl::getPointersChainCost(
  ...
  if (Info.isSameBase() && Info.isKnownStride()) {
    ...
    // into constants. Mcasm memory addressing allows encoding it into
...
InstructionCost
McasmTTIImpl::getAddressComputationCost(Type *PtrTy, ScalarEvolution *SE,
                                      const SCEV *Ptr,
                                      TTI::TargetCostKind CostKind) const {
  ...
  // modes of Mcasm regardless of the stride value. We dont believe that there
...
InstructionCost
McasmTTIImpl::getArithmeticReductionCost(unsigned Opcode, VectorType *ValTy,
...
InstructionCost McasmTTIImpl::getMinMaxCost(Intrinsic::ID IID, Type *Ty,
                                          TTI::TargetCostKind CostKind,
...
InstructionCost
McasmTTIImpl::getMinMaxReductionCost(Intrinsic::ID IID, VectorType *ValTy,
                                   FastMathFlags FMF,
                                   TTI::TargetCostKind CostKind) const {
  std::pair<InstructionCost, MVT> LT = getTypeLegalizationCost(ValTy);
...
InstructionCost McasmTTIImpl::getIntImmCost(int64_t Val) const {
  if (Val == 0)
    return TTI::TCC_Free;
...
InstructionCost McasmTTIImpl::getIntImmCost(const APInt &Imm, Type *Ty,
                                          TTI::TargetCostKind CostKind) const {
...
InstructionCost McasmTTIImpl::getIntImmCostInst(unsigned Opcode, unsigned Idx,
  ...
  case Instruction::And:
    ...
    if (Idx == 1 && ImmBitWidth == 64 && ST->is64Bit() && ST->hasBMI() &&
        Imm.isMask())
      return McasmTTIImpl::getIntImmCost(ST->hasBMI2() ? 255 : 65535);
    ImmIdx = 1;
    break;
  ...
  if (Idx == ImmIdx) {
    ...
    InstructionCost Cost = McasmTTIImpl::getIntImmCost(Imm, Ty, CostKind);
    return (Cost <= NumConstants * TTI::TCC_Basic)
               ? static_cast<int>(TTI::TCC_Free)
               : Cost;
  }

  return McasmTTIImpl::getIntImmCost(Imm, Ty, CostKind);
}

InstructionCost
McasmTTIImpl::getIntImmCostIntrin(Intrinsic::ID IID, unsigned Idx,
                                const APInt &Imm, Type *Ty,
                                TTI::TargetCostKind CostKind) const {
  assert(Ty->isIntegerTy());
...
InstructionCost McasmTTIImpl::getCFInstrCost(unsigned Opcode,
                                           TTI::TargetCostKind CostKind,
                                           const Instruction *I) const {
  if (CostKind != TTI::TCK_RecipThroughput)
...
int McasmTTIImpl::getGatherOverhead() const {
...
int McasmTTIImpl::getScatterOverhead() const {
  if (ST->hasAVX512())
    return 2;
...
InstructionCost McasmTTIImpl::getGSVectorCost(unsigned Opcode,
                                            TTI::TargetCostKind CostKind,
...
InstructionCost
McasmTTIImpl::getGatherScatterOpCost(const MemIntrinsicCostAttributes &MICA,
                                   TTI::TargetCostKind CostKind) const {
...
bool McasmTTIImpl::isLSRCostLess(const TargetTransformInfo::LSRCost &C1,
                               const TargetTransformInfo::LSRCost &C2) const {
  // Mcasm specific here are "instruction number 1st priority".
...
bool McasmTTIImpl::canMacroFuseCmp() const {
  return ST->hasMacroFusion() || ST->hasBranchFusion();
}

static bool isLegalMaskedLoadStore(Type *ScalarTy, const McasmSubtarget *ST) {
  if (!ST->hasAVX())
    return false;
...
bool McasmTTIImpl::isLegalMaskedLoad(Type *DataTy, Align Alignment,
                                   unsigned AddressSpace,
...
bool McasmTTIImpl::isLegalMaskedStore(Type *DataTy, Align Alignment,
                                    unsigned AddressSpace,
                                    TTI::MaskKind MaskKind) const {
  Type *ScalarTy = DataTy->getScalarType();
...
bool McasmTTIImpl::isLegalNTLoad(Type *DataType, Align Alignment) const {
...
bool McasmTTIImpl::isLegalNTStore(Type *DataType, Align Alignment) const {
  unsigned DataSize = DL.getTypeStoreSize(DataType);
...
bool McasmTTIImpl::isLegalBroadcastLoad(Type *ElementTy,
...
bool McasmTTIImpl::isLegalMaskedExpandLoad(Type *DataTy, Align Alignment) const {
  if (!isa<VectorType>(DataTy))
    return false;
...
bool McasmTTIImpl::isLegalMaskedCompressStore(Type *DataTy,
                                            Align Alignment) const {
  return isLegalMaskedExpandLoad(DataTy, Alignment);
}

bool McasmTTIImpl::supportsGather() const {
...
bool McasmTTIImpl::forceScalarizeMaskedGather(VectorType *VTy,
                                            Align Alignment) const {
...
bool McasmTTIImpl::isLegalMaskedGatherScatter(Type *DataTy,
                                            Align Alignment) const {
  Type *ScalarTy = DataTy->getScalarType();
  if (ScalarTy->isPointerTy())
    return true;
...
bool McasmTTIImpl::isLegalMaskedGather(Type *DataTy, Align Alignment) const {
  if (!supportsGather() || !ST->preferGather())
    return false;
  return isLegalMaskedGatherScatter(DataTy, Alignment);
}

bool McasmTTIImpl::isLegalAltInstr(VectorType *VecTy, unsigned Opcode0,
                                 unsigned Opcode1,
...
bool McasmTTIImpl::isLegalMaskedScatter(Type *DataType, Align Alignment) const {
...
bool McasmTTIImpl::hasDivRemOp(Type *DataType, bool IsSigned) const {
  EVT VT = TLI->getValueType(DL, DataType);
  return TLI->isOperationLegal(IsSigned ? ISD::SDIVREM : ISD::UDIVREM, VT);
}

bool McasmTTIImpl::isExpensiveToSpeculativelyExecute(const Instruction *I) const {
...
bool McasmTTIImpl::isFCmpOrdCheaperThanFCmpZero(Type *Ty) const { return false; }

bool McasmTTIImpl::areInlineCompatible(const Function *Caller,
...
bool McasmTTIImpl::areTypesABICompatible(const Function *Caller,
  ...
  if (TM.getSubtarget<McasmSubtarget>(*Caller).useAVX512Regs() ==
      TM.getSubtarget<McasmSubtarget>(*Callee).useAVX512Regs())
    return true;
...
McasmTTIImpl::TTI::MemCmpExpansionOptions
McasmTTIImpl::enableMemCmpExpansion(bool OptSize, bool IsZeroCmp) const {
...
bool McasmTTIImpl::prefersVectorizedAddressing() const {
  return supportsGather();
}

bool McasmTTIImpl::supportsEfficientVectorElementLoadStore() const {
  return false;
}

bool McasmTTIImpl::enableInterleavedAccessVectorization() const {
...
InstructionCost McasmTTIImpl::getInterleavedMemoryOpCostAVX512(
  ...
  if (Opcode == Instruction::Load) {
    ...
    // McasmInterleavedAccess pass will generate.
    // The cost of loads and stores are computed separately from the table.

    // McasmInterleavedAccess support only the following interleaved-access group.
...
InstructionCost McasmTTIImpl::getInterleavedMemoryOpCost(
...
InstructionCost McasmTTIImpl::getScalingFactorCost(Type *Ty, GlobalValue *BaseGV,
  ...
  //
  // For some Mcasm architectures, this is even worse because for instance for
...
unsigned McasmTTIImpl::getStoreMinimumVF(unsigned VF, Type *ScalarMemTy,
...
bool McasmTTIImpl::isProfitableToSinkOperands(Instruction *I,
...
bool McasmTTIImpl::useFastCCForInternalCall(Function &F) const {
  ...
  for (User *U : F.users()) {
    ...
    if (TM.getSubtarget<McasmSubtarget>(*CallerFunc).hasEGPR() != HasEGPR)
      return false;
  }
