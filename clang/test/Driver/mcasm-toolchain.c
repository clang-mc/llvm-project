...
// LTO: opt{{(\.exe)?}}" "{{[^"]*mcasm-linked[^"]*\.bc}}"
// LTO-SAME: "-passes=internalize,default<O{{[0-9]}}>,globaldce"
// LTO-SAME: "-internalize-public-api-list=main,abort,memcpy,memmove,memset,memcmp,__mc_str_begin_rt,__mc_str_append_rt"
// LTO-SAME: "-o" "{{.*mcasm-opt.*\.bc}}"
// LTO: "-cc1"
// LTO-SAME: "-triple" "mcasm"
// LTO-SAME: "-S"
// LTO-SAME: "-x" "ir"
